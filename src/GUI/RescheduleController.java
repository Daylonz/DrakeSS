...
public class RescheduleController implements Initializable {
    ...
    public void doReschedule(ActionEvent event) throws IOException, MessagingException
    {
        setEndTime();
        if (startcb.getValue() == null || endcb.getValue() == null)
        {
            ...
            alert.setHeaderText("Rescheduling requirements not met");
            ...
            if (!overlap)
            {
                Client.selectedmeeting.setStart(start);
                Client.selectedmeeting.setEnd(end);
                ...
                alert.setContentText("Your meeting has successfully been rescheduled. Thank you.");
                alert.showAndWait();
